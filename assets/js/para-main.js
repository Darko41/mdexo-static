...
$main.poptrox({
    ...
    popupCloserText: '',
    popupLoaderText: '',
    selector: '.item.thumb a.image[href$=".jpg"], .item.thumb a.image[href$=".jpeg"], .item.thumb a.image[href$=".png"], .item.thumb a.image[href$=".gif"]',
    caption: function($a) {
...
$('.item.thumb a.image[href$=".html"]').on('click', function(e) {
    e.stopPropagation();
